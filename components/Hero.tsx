  ...
  return (
    <div className="h-screen mx-auto bg-slate-50 flex flex-col items-center select-none">
      <div className="pt-20 flex flex-col items-center justify-center mb-[6rem] lg:mb-[13rem]">
        ...
        <p className="absolute mb-20 top-[12rem] lg:top-[18rem] max-w-md lg:max-w-2xl text-[10px] lg:text-[20px] tracking-normal font-bold text-center text-gray-500 -translate-y-10 lg:-translate-y-20">
          <i>
